...
def recog_text():
    ...
    while True:
        ...
        if "hoàn thành" in text_of_recognition or "hoàng thành" in text_of_recognition or "hòn thành" in text_of_recognition or "complete" in text_of_recognition:
...
def detec_face():
    ...
    while True:
        ...
        if "hoàn thành" in text_face or "hoàng thành" in text_face or "hòn thành" in text_face or "complete" in text_face:
...
def detec_ob():
    ...
    while True:
        ...
        if "hoàn thành" in check_detec_ob or "hoàng thành" in check_detec_ob or "hòn thành" in check_detec_ob or "complete" in check_detec_ob:
            img = imgg
            checkpoint = False
            threshold = 0.3
...
def add_train_pp(lang, id_voices):
    ...
    NewUser.add_pp(str(text_add_pp))
    print("Thêm ảnh xong")
    data_preprocess.pre()
    train_main.train()
